...
celltype = pd.read_csv(
    "./data/Part3_VisualCortex/GSE102827_cell_type_assignments.csv", index_col=0
)
...
lims = ax.get_ylim()
ax.vlines(
    x=countcutoff, ymin=0, ymax=lims[1], linestyle="--", label="minimum threshold"
)
_ = ax.set_ylim(lims)
...
save_df_to_npz(
    TPM,
    "./data/Part3_VisualCortex/GSE102827_merged_ExcitatoryInhibatoryNeurons_filt_TPM.npz",
)
save_df_to_npz(
    counts,
    "./data/Part3_VisualCortex/GSE102827_merged_ExcitatoryInhibatoryNeurons_filt_counts.npz",
)
