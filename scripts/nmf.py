...
input_counts = pd.read_csv(
    "./simulated_example_data/filtered_counts.txt", sep="\t", index_col=0
)
...
my_plot_nmf(
    norm_counts.X, 10, k0=1, k=15, fig_name="./nmf_cv_curve_r_5_k_1_14_run_1.pdf"
)
